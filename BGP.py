...
def config_worker( device, creds ):
    ...
    print("---------------------------------------------")
    print('Apply BGP configuration')
    Cfile= '/home/devasc/device-creds/BGP/'+ device['name']+ '-BGP'
    """with open (device['name']+ '-BGP', 'r') as f:
        lines= f.readlines()
    print(lines)"""
    print(Cfile)
    print("---------------------------------------------")
    ...
    #lines =['router ospf 1', 'network 192.168.2.0 0.0.0.3 area 0', 'network 192.168.150.0 0.0.0.0 area 0']
        ...
        print(device['name']+ ' does not have any BGP configuration')    
